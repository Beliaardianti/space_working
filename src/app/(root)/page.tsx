    ...
    <main>
      ...
      >
        <div className="pt-[226px] container mx-auto">
          <div className="max-w-[555px] sm:text-white">
            <Title
            ...
            <div className="pt-[50px] flex items-center hidden">
              <div className="grow">
                <Input
...
<section id="categories-section" className="bg-gray-light">
  <div className="px-4 md:px-6 lg:px-8 xl:px-10 py-8 xl:py-12 mx-auto container">
...
<section
  id="benefits-section"
  className="px-4 sm:px-6 md:px-8 lg:px-10 xl:container xl:mx-auto mt-10"
>
